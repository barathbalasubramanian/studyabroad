...
import StylesUni from './university.module.css';
...
function UniversityCard() {
    ...
    <div className='flex flex-col gap-10 items-center justify-center'> 
        <div className={`${StylesUni.selectCon} flex flex-col gap-8 mt-14 p-8 w-3/4 items-center justify-center`}>
            <div className='font-bold text-2xl'>Select Country</div>
            <div className={`w-2/3 flex items-center justify-center ${StylesUni.selectDiv}`}>
                <select className={`${StylesUni.select}`} value={selectedValue} onChange={handleDropdownChange}>
                    <option value="">Select a Country...</option>
                    <option value="option1">United States</option>
                    <option value="option2">UK London</option>
                    <option value="option3">India</option>
                </select>
            </div>
        </div>
        <div className='flex items-center justify-between w-3/4 m-auto py-8'>
            <div className='font-bold text-xl'>University Search</div>
            <div>
                <div className={`flex ${StylesUni.inputDiv}`} >
                    <input type="text" className={StylesUni.input} />
                    <Image className={StylesUni.searchIcon} src="/assets/search.svg" alt='Search' width={100} height={100}/>
                </div>
            </div>
        </div>
